...
public class HelperTests
{
    ...
    [TestCase(typeof(float), TestName = "Get supported operations for number Single")]
    ...
    public void LoadingSameCustomOperationTwice_Failure()
    {
        ...
        Assert.That(helper.Operations.Where(o => o.Name == operations[0].Name).Count, Is.EqualTo(1));
